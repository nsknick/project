<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="活动名称" prop="activityname">
          <el-input v-model="ruleForm.activityname"
              placeholder="活动名称" clearable  :readonly="ro.activityname"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="活动名称" prop="activityname">
              <el-input v-model="ruleForm.activityname"
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="活动类型" prop="activitytype">
          <el-input v-model="ruleForm.activitytype"
              placeholder="活动类型" clearable  :readonly="ro.activitytype"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="活动类型" prop="activitytype">
              <el-input v-model="ruleForm.activitytype"
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="人数" prop="people">
          <el-select :disabled="ro.people" v-model="ruleForm.people" placeholder="请选择人数">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="人数" prop="people">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="报名说明" prop="description">
          <el-input v-model="ruleForm.description"
              placeholder="报名说明" clearable  :readonly="ro.description"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="报名说明" prop="description">
              <el-input v-model="ruleForm.description"
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.registrationtime" label="报名时间" prop="registrationtime">
              <el-input v-model="ruleForm.registrationtime"
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="学号" prop="studentid">
          <el-input v-model="ruleForm.studentid"
              placeholder="学号" clearable  :readonly="ro.studentid"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="学号" prop="studentid">
              <el-input v-model="ruleForm.studentid"
...
export default {
  ...
  "dateHeight": "40px",
  "selectBorderColor": "#518f8c",
  "inputBorderColor": "#518f8c",
  "uploadBorderColor": "#518f8c",
  "textareaFontColor": "#606266",
  "selectBorderWidth": "5px 2px",
  "dateFontColor": "#606266",
  "btnCancelBorderWidth": "1px",
  "uploadBorderWidth": "5px 2px",
  "textareaFontSize": "14px",
  "selectBorderRadius": "4px",
  "selectFontColor": "#606266",
  "btnSaveBorderColor": "#518f8c",
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
		...
		if(json.studentid!=''&&json.studentid){
                this.ruleForm.studentid = json.studentid
	    		this.ro.studentid = true;
		}
		...
		if(json.phonenumber!=''&&json.phonenumber){
...
var objcross = this.$storage.getObj('crossObj');
      ...
      if(objcross!=null) {
	      objcross.people = objcross.people - this.ruleForm.people
	      if(objcross.people<0){
