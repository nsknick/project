<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="活动时间" prop="time">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.time" label="活动时间" prop="time">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="人数" prop="people">
          <el-input v-model="ruleForm.people"
              placeholder="人数" clearable  :readonly="ro.people"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="活动场地" prop="location">
          <el-input v-model="ruleForm.location"
              placeholder="活动场地" clearable  :readonly="ro.location"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="活动场地" prop="location">
              <el-input v-model="ruleForm.location"
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="活动介绍" prop="introduction">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.introduction" label="活动介绍" prop="introduction">
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `activityinfo/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.activityinfoCrossAddOrUpdateFlag = false;
						 this.parent.search();
