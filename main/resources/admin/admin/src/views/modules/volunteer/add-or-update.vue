<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.profilepicture" label="头像" prop="profilepicture">
          <file-upload
          tip="点击上传头像"
          action="file/upload"
          :limit="3"
          ...
          @change="profilepictureUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.profilepicture" label="头像" prop="profilepicture">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.profilepicture.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="班级" prop="classes">
          <el-input v-model="ruleForm.classes"
              placeholder="班级" clearable  :readonly="ro.classes"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="班级" prop="classes">
              <el-input v-model="ruleForm.classes"
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.gender = true;
          ...
          if(o=='profilepicture'){
            this.ruleForm.profilepicture = obj[o];
	    this.ro.profilepicture = true;
            continue;
          }
          if(o=='age'){
	    ...
	    this.ro.age = true;
          ...
          if(o=='classes'){
            this.ruleForm.classes = obj[o];
	    this.ro.classes = true;
            continue;
          }
          if(o=='email'){
    ...
    onSubmit() {
      ...
      if((this.ruleForm.studentid.length<8)){
...
var objcross = this.$storage.getObj('crossObj');
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `volunteer/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.volunteerCrossAddOrUpdateFlag = false;
						 this.parent.search();
    ...
    profilepictureUploadChange(fileUrls) {
